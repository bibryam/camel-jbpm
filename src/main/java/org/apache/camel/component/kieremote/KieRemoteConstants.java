...
public interface KieRemoteConstants {
    String VALUE = "CamelKieRemoteValue";
    String OPERATION = "CamelKieRemoteOperation";
    String PROCESS_ID = "CamelKieRemoteProcessId";
    String PROCESS_INSTANCE_ID = "CamelKieRemoteProcessInstanceId";
    ...
    String WORK_ITEM_ID = "CamelKieRemoteWorkItemId";
    ...
    String ENTITY_LIST = "CamelKieRemoteEntityList";
    String STATUS_LIST = "CamelKieRemoteStatusList";
}
